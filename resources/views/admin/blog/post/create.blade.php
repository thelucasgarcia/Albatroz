...
<div class="row">
   ...
   {!! Form::open(['method' => 'POST', 'route' => 'admin.blog.post.store', 'files' => 'true']) !!}
        ...
        <div class="box box-info pad">
            ...
            <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('category', $categories, null, ['id' => 'category', 'class' => 'form-control select2', 'required' => 'required','placeholder' => 'Select a category']) !!}
