        ...
        <div class="box box-info pad">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <a href="{{ route('admin.school.gallery.edit',$school->id) }}" class="btn btn-success btn-sm">
            ...
            <div class="box-body">
                <div class="row">
                    @forelse($school->gallery as $image)
                    <div class="col-md-3">
                      <div class="box box-primary">
                        ...
                        <div class="box-body">
                          <img src="{{ $image->photo }}" class="img-responsive" alt="">
                            ...
                            {!! Form::open(['method' => 'DELETE', 'route' => ['admin.school.gallery.destroy', $image->id]]) !!}
