...
<div class="row">
    <div class="col-sm-4 col-md-3">
        <h4 class="search-results-title"><i class="soap-icon-search"></i><b>{{ $schools->count() }}</b> results found.</h4>
            ...
            <div class="panel style1 arrow-right">
                <h4 class="panel-title">
                    ...
                    <div class="panel-content">
                        	...
                        	{!! Form::open(['method' => 'GET', 'route' => 'site.school.index','id' => 'schools-filter-form']) !!}
                        	
                        	    <div id="countries-list-wrapper">
                        	    	@include('app.school.ajax.country-wrapper')
                        	    </div>

                        	    <div id="cities-list-wrapper">
                        	    	@include('app.school.ajax.city-wrapper')
                        	    </div>

                        	    <div id="schools-list-wrapper">
                        	    	@include('app.school.ajax.school-wrapper')
                        	    </div>
        ...
        <div class="hotel-list listing-style3 hotel">
            ...
            <article class="box">
                <figure class="col-sm-5 col-md-4">
                    <a title="" href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="160" alt="" src="{{ $school->image }}"></a>
                </figure>
                <div class="details col-sm-7 col-md-8">
                    <div>
                        <div>
                            <h4 class="box-title">{{ $school->name }}<small><i class="soap-icon-departure yellow-color"></i> {{ $school->city->name }}, {{ $school->city->country->name }}</small></h4>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <a class="button btn-small full-width text-center" title="" href="{{ route('site.school.show',$school->slug) }}">SELECT</a>
                        </div>
                    </div>
                </div>
            </article>
