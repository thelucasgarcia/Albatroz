...
<div id="main">
    <div class="row">
        <div class="col-sm-4 col-md-3">
            <h4 class="search-results-title"><i class="soap-icon-search"></i><b>{{ $destination->cities->count() }}</b> results found.</h4>
        ...
        <div class="col-sm-8 col-md-9">
            ...
            <div class="hotel-list">
                <div class="row image-box listing-style2">
                    ...
                    @forelse($destination->cities as $city)

                    <div class="col-sms-6 col-sm-6 col-md-4">
                        <article class="box">
                            <figure>
                                <img src="{{ asset('storage/country/'.$city->country->slug.'/'.$city->slug.'/'.$city->image) }}" alt="" width="270" height="160">
                            </figure>
                            <div class="details">
                                <a title="View all" href="{{ route('site.destination.city',[$destination->slug,$city->slug]) }}" class="pull-right button uppercase">select</a>
                                <h4 class="box-title">{{ $city->name }}<small>{{ $city->country->name }}</small></h4>
                            </div>
                        </article>               
                    </div>
                    @empty
